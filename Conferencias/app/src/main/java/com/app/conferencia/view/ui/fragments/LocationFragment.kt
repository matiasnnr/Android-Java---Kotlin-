...
class LocationFragment : Fragment(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    override fun onMapReady(googleMap: GoogleMap?) {
        ...
        markerOptions.title("Teatro Diego Rivera")

        val bitmapDraw = context?.applicationContext?.let { ContextCompat.getDrawable(it, R.drawable.icon_conferencias) } as BitmapDrawable
