package com.app.pruebaandroid.repository.api;
...
public class AutoCompleteAPI {
    ...
    public ArrayList<String> autoComplete(String input){
        ...
        try {
            StringBuilder sb = new StringBuilder(Constants.BASE_URL + "place/autocomplete/json?");
            sb.append("input="+input);
            sb.append("&key=" + Constants.GOOGLE_PLACE_API_KEY);
